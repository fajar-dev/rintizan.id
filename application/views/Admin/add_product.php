                      ...
                      <div class="col-lg-6 col-md-8">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold">Add Product</h6>
                            </div>
                            <div class="card-body">
                            ...
                            <?php echo form_open_multipart('Admin/tambah_produk');?>
                                <div class="form-group row">
                                  <label for="input" class="col-lg-12 col-form-label">Product Name :</label>
                                    <div class="col-lg-12">
                                      <input type="text" class="form-control" id="input" name="nama"  required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                  <label for="input" class="col-lg-12 col-form-label">Price :</label>
                                    <div class="col-lg-12">
                                      <input type="number" class="form-control" id="input" name="harga"  required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                  <label for="input" class="col-lg-12 col-form-label">No. WA :</label>
                                    <div class="col-lg-12">
                                      <input type="number" class="form-control" id="input" name="wa" placeholder="ex: 628..." required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                  <label for="input" class="col-lg-12 col-form-label">gambar :</label>
                                    <div class="col-lg-12">
                                      <input type="file" class="form-control" id="input" name="foto" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                  <label for="input" class="col-lg-12 col-form-label">deskripsi :</label>
                                    <div class="col-lg-12">
                                      <textarea class="form-control" style="white-space: pre-line;" name="deskripsi" row="1"></textarea>
                                    </div>
                                </div>
                                <hr>
